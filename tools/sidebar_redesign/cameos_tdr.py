...
TD_<Name>_128x96.png. 49 of the 54 were GENERATED by an image model from the 1995 PDF
manual renders (see art/cameos-tdr/provenance/RECIPE.md for the model and the call);
...
#
# That set was generated from the 1995 PDF manual renders, and the manual has no render for
...
def build():
    ...
    print("  %d generated from the manual renders, %d kept from the earlier set (%s)"
