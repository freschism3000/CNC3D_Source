...
**	infantry type.
*/
InfantryTypeClass const* const InfantryTypeClass::Pointers[INFANTRY_COUNT] = {&E1,
                                                                              &E2,
                                                                              &E3,
                                                                              &E4,
                                                                              &E5,
...
BuildingClass* InfantryTypeClass::Who_Can_Build_Me(bool intheory, bool legal, HousesType house) const
{
    ...
    for (int index = 0; index < Buildings.Count(); index++) {
        ...
        if (building && !building->IsInLimbo && building->House->Class->House == house
            && building->Mission != MISSION_DECONSTRUCTION && building->Class->ToBuild == RTTI_INFANTRYTYPE
