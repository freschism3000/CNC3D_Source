...
// font block. This is the case when no content root was registered at init
// time and none of the engine fonts loaded.
...
void Simple_Text_Print(char const* text, unsigned x, unsigned y, unsigned fore, unsigned back, TextPrintType flag)
{
    ...
    static unsigned char _textpalmedium[16] = {0, 25, 119, 41, 0, 158, 0, 178, 125, 0, 202, 0, 0, 0, 0, 0};

    static unsigned char _textpalbright[16] = {0, 24, 2, 4, 0, 5, 0, 176, 127, 0, 201, 0, 0, 0, 0, 0};
    ///////////////////////#endif	//(0)
